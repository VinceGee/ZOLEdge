...
public class VoipFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        rootView = LayoutInflater.from(context).inflate(R.layout.voip_trouble, container, false);
        //callBtn = (Button) rootView.findViewById(R.id.button);

        TextView cash = rootView.findViewById(R.id.voip_troubleee);

        cash.setText(Html.fromHtml(getString(R.string.voip_trouble)));
