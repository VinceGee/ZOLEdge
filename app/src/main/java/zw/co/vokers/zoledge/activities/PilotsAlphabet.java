...
import zw.co.vokers.zoledge.utils.MaterialLetterIcon;

public class PilotsAlphabet extends AppCompatActivity {
    ...
    @Override protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.pilot_alphabet);
