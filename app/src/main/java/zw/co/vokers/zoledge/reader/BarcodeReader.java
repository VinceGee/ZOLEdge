package zw.co.vokers.zoledge.reader;
...
import zw.co.vokers.zoledge.reader.camera.CameraSource;
import zw.co.vokers.zoledge.reader.camera.CameraSourcePreview;
import zw.co.vokers.zoledge.reader.camera.GraphicOverlay;
    ...
    public void onRequestPermissionsResult(int requestCode,
        ...
        DialogInterface.OnClickListener listener = new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int id) {
                ...
                // close this fragment if permissions not granted
                // or pass a callback
                // finis()
            }
        };
