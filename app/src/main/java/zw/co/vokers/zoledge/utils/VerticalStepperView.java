...
public class VerticalStepperView extends FrameLayout implements IStepperView {
     ...
     *
     * @param index Index
     * @param errorText ErrorModel text or null
     */
     ...
     *
     * @param index Index
     * @return ErrorModel text or null (means no error)
     */
     ...
     *
     * @param color ErrorModel Highlight Color
     */
     ...
     * Set error highlight color
     *
     * @param colorRes ErrorModel Highlight Color resource
     */
