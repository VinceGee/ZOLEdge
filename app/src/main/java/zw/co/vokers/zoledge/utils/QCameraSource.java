...
public class QCameraSource {
    ...
    public static class Builder {
        ...
        private QCameraSource mQCameraSource = new QCameraSource();
        ...
        public Builder(Context context, Detector<?> detector) {
            ...
            mDetector = detector;
            mQCameraSource.mContext = context;
        }
        ...
        public Builder setRequestedFps(float fps) {
            ...
            mQCameraSource.mRequestedFps = fps;
            return this;
        }

        public Builder setFocusMode(@FocusMode String mode) {
            mQCameraSource.mFocusMode = mode;
            return this;
        }

        public Builder setFlashMode(@FlashMode String mode) {
            mQCameraSource.mFlashMode = mode;
            return this;
        }
        ...
        public Builder setRequestedPreviewSize(int width, int height) {
            ...
            mQCameraSource.mRequestedPreviewWidth = width;
            mQCameraSource.mRequestedPreviewHeight = height;
            return this;
        }
         ...
         */
        public QCameraSource build() {
            mQCameraSource.mFrameProcessor = mQCameraSource.new FrameProcessingRunnable(mDetector);
            return mQCameraSource;
        }
    }
    ...
    public QCameraSource start() throws IOException {
        synchronized (mCameraLock) {
            if (mCamera != null) {
                return this;
            }
     ...
     */
    @RequiresPermission(Manifest.permission.CAMERA)
    public QCameraSource start(SurfaceHolder surfaceHolder) throws IOException {
        synchronized (mCameraLock) {
            if (mCamera != null) {
                return this;
            }
