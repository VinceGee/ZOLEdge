 ...
 * </ol>
 */
public class QGraphicOverlay<T extends QGraphicOverlay.Graphic> extends View {
    ...
    public static abstract class Graphic {
        ...
        public Graphic(QGraphicOverlay overlay) {
            mOverlay = overlay;
        }
    ...
    public QGraphicOverlay(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
